![npm](https://img.shields.io/npm/v/@zitterorg/harum-ratione.svg)
![GitHub](https://img.shields.io/github/license/onubo/@zitterorg/harum-ratione.svg)
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/onubo/@zitterorg/harum-ratione/issues)

# @zitterorg/harum-ratione
...
![console log demo](https://raw.githubusercontent.com/onubo/@zitterorg/harum-ratione/master/demo/demo-@zitterorg/harum-ratione.png)
...
```sh
npm install --save @zitterorg/harum-ratione
```

OR

```sh
yarn add @zitterorg/harum-ratione
```

OR

```sh
expo install @zitterorg/harum-ratione
```

## Quick Start

```javascript
import { logger } from "@zitterorg/harum-ratione";
...
```javascript
import { logger, consoleTransport } from "@zitterorg/harum-ratione";
...
```javascript
import { logger, transportFunctionType } from "@zitterorg/harum-ratione";
...
```javascript
import { logger, fileAsyncTransport } from "@zitterorg/harum-ratione";
...
@zitterorg/harum-ratione includes some preset transports. You can import the one of your choice:
`import { logger, <transportName> } from '@zitterorg/harum-ratione';`

#### Example

```javascript
import { logger, mapConsoleTransport } from "@zitterorg/harum-ratione";
...
```javascript
import { logger, sentryTransport } from "@zitterorg/harum-ratione";
...
All calls to `console.*` will then be handled by your @zitterorg/harum-ratione logger and then you can manage their visibility via severity, or change their transports.
...
// all of the following console calls will use your @zitterorg/harum-ratione logger
